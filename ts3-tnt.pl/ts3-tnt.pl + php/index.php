	...
	<div class="status" id="status">
				...
				if($tsAdmin->getElement('success', $tsAdmin->connect()))
				{
					...
					echo '		
						...
						<p>Adres IP: <a href="ts3server://ts3-tnt.pl" class="status-link" >ts3-tnt.pl</a><br>
						Status Serwera: <b class="status-color">'.$nazwa.'</b> <br>
	...
	<div class="parallax4"></div>
		<div class="contact" id="contact">
			...
			<div class="container">
				...
				Wejdź na TeamSpeak3 lub napisz do nas wiadomość</p>
				</div>
				...
				<div class="col-half">
						...
						<input type="text" placeholder="Nick z TS" name="name" id="name"><br>
						 </div>
						 <div class="form-group long2">
							<input type="text" placeholder="Email" name="email" id="email"><br>
						 </div>
						<textarea name="message" placeholder="Napisz Wiadomość"></textarea><br>
						<button type="submit" class="button button-dark" id="wyslij">Prześlij</button>
						</form>
				</div>
				<div style="clear: both;"></div>
